...
class _DrawerWidgetState extends State<DrawerWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: <Widget>[
        _getHeader(),
        _getDrawerItem(getTranslated(context, "EDIT_PROFILE_LBL")!, 'Profile'),
        _getDrawerItem(getTranslated(context, "ORDERS")!, 'Order'),
        _getDrawerItem(getTranslated(context, "CHAT") ?? "CHAT", 'Chat'),
        const Divider(),
        _getDrawerItem(getTranslated(context, "WALLETHISTORY")!, 'wallet'),
        _getDrawerItem(getTranslated(context, "PRODUCTS")!, 'Product'),
        ...
        _getDrawerItem(
            getTranslated(context, 'Stock Management')!, 'StockManagement'),
        const Divider(),
        _getDrawerItem(
            getTranslated(context, "ChangeLanguage")!, 'ChangeLanguage'),
        _getDrawerItem(getTranslated(context, "T_AND_C")!, 'PrivacyPolicy'),
        _getDrawerItem(
            getTranslated(context, "PRIVACYPOLICY")!, 'Terms&Conditions'),
        const Divider(),
        _getDrawerItem(getTranslated(context, "CONTACTUS")!, 'ContactUS'),
        _getDrawerItem(
            getTranslated(context, "Return Policy")!, 'ReturnPolicy'),
        _getDrawerItem(getTranslated(context, "Shipping Policy")!, 'Shipping'),
        const Divider(),
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            SvgPicture.asset(
                              DesignConfiguration.setNewSvgPath('wallet'),
                            ),
                            Text(

                              ...
                              Padding(
                                ...
                                child: Row(
                                  children: [
                                    boxesDesingHome(
                                      'SoldOut',
                                      getTranslated(context, "Sold Out")!,
                                    ...
                                    boxesDesingHome(
                                      'LowStock',
                                      getTranslated(context, 'Low Stock')!,
    ...
    ApiBaseHelper().postAPICall(getSettingsApi, parameter).then(
      (getdata) async {
        ...
        if (!error) {
          ...
          DELIVERY_BOY_OTP_SETTING = data['is_delivery_boy_otp_setting_on'];
          // print(
          //     "DELIVERY_BOY_OTP_SETTING------->${DELIVERY_BOY_OTP_SETTING.toString()}");
          setState(
            () {},
          );
